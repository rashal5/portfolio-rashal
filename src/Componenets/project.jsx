  ...
  return (
    <div className="pb-4 px-8">
      <motion.h2 whileInView={{ opacity:1,y:0}} 
                ...
                transition={{ duration:0.5}} className="my-20 text-center text-4xl f5">Projects</motion.h2>
      <div>
        {PROJECTS.map((project, index) => (
          <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
            ...
            <motion.div whileInView={{ opacity:1,x:0}} 
              ...
              <h3 className="mb-2 font-semibold text-2xl f5">{project.title}</h3>
              <p className="mb-4 p6">{project.description}</p>
