        ...
        <div className="mb-8 flex flex-wrap lg:justify-center">
          ...
          >
            ...
            <p className="mb-4 text-stone-400">
              ...
              fundamental concepts and techniques used to organize and manipulate data efficiently in language and Proficient in handling application data with precision using MongoDB and Mysql <br />
              • Succeeded in collaborative development setups, leveraging Git for version control to uphold code quality and all-encompassing methodology that encompasses backend logic.
            </p>
